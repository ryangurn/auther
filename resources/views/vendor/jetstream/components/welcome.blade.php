<div class="p-6 pb-12 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6 text-gray-500">
        auther is the place for you to control user access controls to any of the daily management portal, this application is the core of the authentication system for that system. if you need to manage things relating to account security or the accounts themselves you are in the correct place.
    </div>
</div>
