            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">revoke access token</h3>
                        <p class="mt-1 text-sm text-gray-600">
                            here you can revoke an oauth access token, effectively meaning that the specific requester will no longer be able to use this particular access token.
                        </p>
                    </div>
                </div>
