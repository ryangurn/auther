            ...
            <div class="md:grid md:grid-cols-3 md:gap-6">
                <div class="md:col-span-1">
                    <div class="px-4 sm:px-0">
                        <h3 class="text-lg font-medium leading-6 text-gray-900">revoke client</h3>
                        <p class="mt-1 text-sm text-gray-600">
                            here you can revoke an oauth client, effectively meaning that the specific client will no longer exist.
                        </p>
                    </div>
                </div>
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                <div class="grid grid-cols-6 gap-6">
                                    ...
                                    <div class="mb-4 col-span-6 sm:col-span-6">
                                        <span class="text-red-600">are you sure you would like to revoke this client: <b>{{ $client->name }}</b>, this action is permanent and can cause roll on effects throughout the various micro-services that are connected.</span>
                                    </div>
                                </div>
                            </div>
